...
type Props = {
    eligibleApplications: Candidate[];
    schedules: { data: any[] };
...
export default function Evaluations({
    ...
    const choose = (candidate: Candidate) => {
        ...
        form.clearErrors();
        form.setData('application_id', String(candidate.id));
    ...
    return (
        <>
            <Head title="Avaliações por candidatura" />
            <main className="app-page">
                <div className="flex items-center gap-3">
                    <UserRoundCheck />
                    <div>
                        <h1 className="text-3xl font-bold">
                            Candidaturas prontas para entrevista
                        </h1>
                        <p className="text-base-content/60">
                            Candidatos ativos que concluíram o DISC e estão
                            preparados para a fase 4 — Entrevista com RH.
                        </p>
                    </div>
                </div>
                <section className="mt-6">
                    <h2 className="text-xl font-bold">
                        Aguardando agendamento ({eligibleApplications.length})
                    </h2>
                            ...
                            <tbody>
                                ...
                                {!eligibleApplications.length && (
                                    <tr>
                                        ...
                                        >
                                            Nenhuma candidatura está pronta para
                                            a fase 4.
                                        </td>
                                    </tr>
                                )}
                        ...
                        <div className="modal-box max-w-3xl">
                            ...
                            >
                                ...
                                <textarea
                                    ...
                                    placeholder="Instruções para o candidato"
                                    value={form.data.public_instructions}
                                    onChange={(e) =>
                                        form.setData(
                                            'public_instructions',
                                            e.target.value,
                ...
                <section className="mt-8">
                    <h2 className="text-xl font-bold">Entrevistas agendadas</h2>
                    <div className="mt-3 overflow-x-auto rounded-box border border-base-300 bg-base-100">
                        <table className="table">
                            <thead>
                                <tr>
